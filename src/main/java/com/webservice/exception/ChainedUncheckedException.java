...
public class ChainedUncheckedException extends RuntimeException
{
   ...
   */
  public ChainedUncheckedException()
  {
    super();
  }
   ...
   */
  public ChainedUncheckedException(String msg)
  {
    super(msg);
  }
   ...
   */
  public ChainedUncheckedException(String msg, Throwable exception)
  {
    super(msg, exception);
